    ...
    constructor(data, params) {
        ...
        if (Array.isArray(data)) {
            ...
            if (this._hasFloat) {
                ...
                else if (numberTypeCheckers.isU64(this._largestNo)) {
                ...
                else if (numberTypeCheckers.isI64(this._largestNo)) {
        ...
        switch (dataType) {
            ...
            case 'f64': {
                ...
                if (this.inner instanceof DenseMatrixF64)
                    return this.inner;
                else if (numberTypeCheckers.isF64(largestNo) && numberTypeCheckers.isF64(smallestNo))
            ...
            case 'f32': {
                ...
                if (this.inner instanceof DenseMatrixF32)
                    return this.inner;
                else if (numberTypeCheckers.isF32(largestNo) && numberTypeCheckers.isF32(smallestNo))
            ...
            case 'i32': {
                ...
                if (this.inner instanceof DenseMatrixF32 || this.inner instanceof DenseMatrixF64)
                    throw new Error(`[DenseMatrix] Cannot convert float data into non-float data`);
                else if (numberTypeCheckers.isI32(largestNo) && numberTypeCheckers.isI32(smallestNo))
            ...
            case 'u32': {
                ...
                if (this.inner instanceof DenseMatrixF32 || this.inner instanceof DenseMatrixF64)
                    throw new Error(`[DenseMatrix] Cannot convert float data into non-float data`);
                else if (numberTypeCheckers.isU32(largestNo) && numberTypeCheckers.isU32(smallestNo))
            ...
            case 'u8': {
                ...
                if (this.inner instanceof DenseMatrixF32 || this.inner instanceof DenseMatrixF64)
                    throw new Error(`[DenseMatrix] Cannot convert float data into non-float data`);
                else if (numberTypeCheckers.isU8(largestNo) && numberTypeCheckers.isU8(smallestNo))
            ...
            case 'u16': {
                ...
                if (this.inner instanceof DenseMatrixF32 || this.inner instanceof DenseMatrixF64)
                    throw new Error(`[DenseMatrix] Cannot convert float data into non-float data`);
                else if (numberTypeCheckers.isU16(largestNo) && numberTypeCheckers.isU16(smallestNo))
            ...
            case 'i64': {
                ...
                if (this.inner instanceof DenseMatrixF32 || this.inner instanceof DenseMatrixF64)
                    throw new Error(`[DenseMatrix] Cannot convert float data into non-float data`);
                else if (numberTypeCheckers.isI64(largestNo) && numberTypeCheckers.isI64(smallestNo))
            ...
            case 'u64': {
                ...
                if (this.inner instanceof DenseMatrixF32 || this.inner instanceof DenseMatrixF64)
                    throw new Error(`[DenseMatrix] Cannot convert float data into non-float data`);
                else if (numberTypeCheckers.isU64(largestNo) && numberTypeCheckers.isU64(smallestNo))
