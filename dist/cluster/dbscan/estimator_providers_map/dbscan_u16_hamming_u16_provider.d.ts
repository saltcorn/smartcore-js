...
declare class DBSCANU16HammingU16Provider implements PredictorProvider<IDBSCANBaseParameters, DBSCANU16HammingU16Parameters, DBSCANU16I32HammingU16> {
    parameters(config: IDBSCANBaseParameters): DBSCANU16HammingU16Parameters;
    estimator(x: DenseMatrix, _y: YType, parameters: DBSCANU16EuclidianU16Parameters): DBSCANU16I32HammingU16;
