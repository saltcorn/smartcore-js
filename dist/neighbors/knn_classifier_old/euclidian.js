import { KNNClassifierF64I64EuclidianF64, KNNClassifierF64BigI64EuclidianF64, KNNClassifierF64BigU64EuclidianF64, KNNClassifierF64EuclidianF64Parameters, } from '../../../core-bindings/index.js';
import { DenseMatrix } from '../../linalg/index.js';
import { EstimatorType } from './index.js';
class KNNClassifierStatics {
    constructor() {
        this.parameters = new KNNClassifierF64EuclidianF64Parameters();
    }
    get params() {
...
class KNNClassifierEuclidian extends KNNClassifierStatics {
    ...
    fit(x, y) {
        ...
        if (y instanceof BigInt64Array) {
            this.estimator = KNNClassifierF64BigI64EuclidianF64.fit(matrix.asF64(), y, this.params);
        }
        else if (y instanceof BigUint64Array) {
            this.estimator = KNNClassifierF64BigU64EuclidianF64.fit(matrix.asF64(), y, this.params);
        }
        else if (!(y instanceof Float64Array)) {
            this.estimator = KNNClassifierF64I64EuclidianF64.fit(matrix.asF64(), y, this.params);
        }
        else {
    ...
    static deserialize(data, estimatorType) {
        ...
        switch (estimatorType) {
            case EstimatorType.F64BigI64:
                instance.estimator = KNNClassifierF64BigI64EuclidianF64.deserialize(data);
                break;
            case EstimatorType.F64BigU64:
                instance.estimator = KNNClassifierF64BigU64EuclidianF64.deserialize(data);
                break;
            case EstimatorType.F64I64:
                instance.estimator = KNNClassifierF64I64EuclidianF64.deserialize(data);
                break;
            default:
