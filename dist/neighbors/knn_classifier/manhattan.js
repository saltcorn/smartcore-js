...
class KNNClassifierStatics {
    parameters = new index_js_1.KNNClassifierF64EuclidianF64Parameters().withDistanceManhattanF64(new index_js_1.ManhattanF64());
    constructor() { }
    get params() {
...
class KNNClassifierManhattan extends KNNClassifierStatics {
    ...
    fit(x, y) {
        ...
        if (y instanceof BigInt64Array) {
            this.estimator = index_js_1.KNNClassifierF64BigI64ManhattanF64.fit(matrix.asF64(), y, this.params);
        }
        else if (y instanceof BigUint64Array) {
            this.estimator = index_js_1.KNNClassifierF64BigU64ManhattanF64.fit(matrix.asF64(), y, this.params);
        }
        else if (!(y instanceof Float64Array)) {
            this.estimator = index_js_1.KNNClassifierF64I64ManhattanF64.fit(matrix.asF64(), y, this.params);
        }
        else {
    ...
    static deserialize(data, estimatorType) {
        ...
        switch (estimatorType) {
            case index_js_3.EstimatorType.F64BigI64:
                instance.estimator = index_js_1.KNNClassifierF64BigI64ManhattanF64.deserialize(data);
                break;
            case index_js_3.EstimatorType.F64BigU64:
                instance.estimator = index_js_1.KNNClassifierF64BigU64ManhattanF64.deserialize(data);
                break;
            case index_js_3.EstimatorType.F64I64:
                instance.estimator = index_js_1.KNNClassifierF64I64ManhattanF64.deserialize(data);
                break;
            default:
