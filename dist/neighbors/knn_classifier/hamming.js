...
exports.KNNClassifierHamming = void 0;
const index_js_1 = require("../../../core-bindings/index.js");
const index_js_2 = require("../../linalg/index.js");
const index_js_3 = require("./index.js");
class KNNClassifierStatics {
    parameters = new index_js_1.KNNClassifierF64EuclidianF64Parameters().withDistanceHammingF64(new index_js_1.HammingF64());
    constructor() { }
    get params() {
...
class KNNClassifierHamming extends KNNClassifierStatics {
    ...
    fit(x, y) {
        ...
        if (y instanceof BigInt64Array) {
            this.estimator = index_js_1.KNNClassifierF64BigI64HammingF64.fit(matrix.asF64(), y, this.params);
        }
        else if (y instanceof BigUint64Array) {
            this.estimator = index_js_1.KNNClassifierF64BigU64HammingF64.fit(matrix.asF64(), y, this.params);
        }
        else if (!(y instanceof Float64Array)) {
            this.estimator = index_js_1.KNNClassifierF64I64HammingF64.fit(matrix.asF64(), y, this.params);
        }
        else {
    ...
    static deserialize(data, estimatorType) {
        ...
        switch (estimatorType) {
            case index_js_3.EstimatorType.F64BigI64:
                instance.estimator = index_js_1.KNNClassifierF64BigI64HammingF64.deserialize(data);
                break;
            case index_js_3.EstimatorType.F64BigU64:
                instance.estimator = index_js_1.KNNClassifierF64BigU64HammingF64.deserialize(data);
                break;
            case index_js_3.EstimatorType.F64I64:
                instance.estimator = index_js_1.KNNClassifierF64I64HammingF64.deserialize(data);
                break;
            default:
...
exports.KNNClassifierHamming = KNNClassifierHamming;
