import { KNNClassifierF64BigI64, KNNClassifierF64BigU64, KNNClassifierF64I64, KNNClassifierParameters, } from '../../core-bindings/index.js';
...
class KNNClassifier {
    constructor(params) {
        this.estimator = null;
        this.parameters = new KNNClassifierParameters();
        if (params) {
    ...
    fit(x, y) {
        ...
        if (y instanceof Float64Array) {
            ...
            this.estimator = KNNClassifierF64BigI64.fit(matrix.asF64(), y, this.parameters);
        }
        else if (y instanceof BigUint64Array) {
            this.estimator = KNNClassifierF64BigU64.fit(matrix.asF64(), y, this.parameters);
        }
        else if (y.every((val) => Number.isInteger(val))) {
            this.estimator = KNNClassifierF64I64.fit(matrix.asF64(), y, this.parameters);
        }
        else {
            throw new Error('Unsupported data type for input arrays.');
        }
    ...
    static deserialize(data, estimatorType) {
        ...
        switch (estimatorType) {
            case EstimatorType.F64BigI64:
                instance.estimator = KNNClassifierF64BigI64.deserialize(data);
                break;
            case EstimatorType.F64BigU64:
                instance.estimator = KNNClassifierF64BigU64.deserialize(data);
                break;
            case EstimatorType.F64I64:
                instance.estimator = KNNClassifierF64I64.deserialize(data);
                break;
            default:
