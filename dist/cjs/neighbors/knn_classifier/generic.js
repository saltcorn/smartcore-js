...
exports.GenericKNNClassifier = void 0;
...
class GenericKNNClassifier {
    ...
    fit(x, y) {
        const matrix = x instanceof index_js_1.DenseMatrix ? x : index_js_1.DenseMatrix.f64(x);
        if (!y || y.length === 0) {
...
exports.GenericKNNClassifier = GenericKNNClassifier;
