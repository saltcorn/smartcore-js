...
class RandomForestRegressorF64F32Provider
  implements
    PredictorProvider<
    ...
    >
{
  ...
  estimator(x: DenseMatrix, y: YType, parameters: RandomForestRegressorParameters): RandomForestRegressorF64F32 {
    const xAsF64 = x.asRsMatrix('f64') as DenseMatrixF64
    const yAsF64 = yAsFloat32Array(y)
    return RandomForestRegressorF64F32.fit(xAsF64, yAsF64, parameters)
  }
  ...
  deserialize(data: Buffer): RandomForestRegressorF64F32 {
    return RandomForestRegressorF64F32.deserialize(data)
  }
}

export default RandomForestRegressorF64F32Provider
