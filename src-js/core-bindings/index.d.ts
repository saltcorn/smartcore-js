...
export declare class KNNRegressor {
  predict(x: DenseMatrix): TypedArrayWrapper
  serialize(): Buffer
 ...
 * .build() on it.
 */
export declare class KNNRegressorBuilder {
  constructor(fitDataX: DenseMatrix, fitDataY: TypedArrayWrapper)
  withWeight(weight: KNNWeightFunction): void
  withAlgorithm(algorithm: KNNAlgorithmName): void
  withDistanceType(distanceType: DistanceVariantType): void
...
export declare class LinearRegressionBuilder {
  constructor(fitDataX: DenseMatrix, fitDataY: TypedArrayWrapper)
...
export declare const enum KNNRegressorPredictOutputType {
  F32 = 'F32'
}
...
export declare const enum LinearRegressionPredictOutputType {
  F64 = 'F64',
  F32 = 'F32',
  I64 = 'I64',
  U64 = 'U64',
