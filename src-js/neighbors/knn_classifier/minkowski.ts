...
abstract class KNNClassifierStatics {
  private parameters: KNNClassifierF64MinkowskiF64Parameters
  ...
  constructor(parameters?: IKNNClassifierParameters) {
    ...
    this.parameters = new KNNClassifierF64EuclidianF64Parameters().withDistanceMinkowskiF64(
...
class KNNClassifierMinkowski
  ...
  implements Estimator<XType, YType, KNNClassifierMinkowski>, Predictor<XType, YType>
{
