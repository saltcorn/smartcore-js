...
abstract class KNNClassifierStatics {
  private parameters = new KNNClassifierF64EuclidianF64Parameters()
...
class KNNClassifierEuclidian
  extends KNNClassifierStatics
  implements Estimator<XType, YType, KNNClassifierEuclidian>, Predictor<XType, YType>
{
