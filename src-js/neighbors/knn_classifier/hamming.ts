...
class KNNClassifierHamming {
  private classifier: GenericKNNClassifier<KNNClassifierF64HammingF64Parameters>

  constructor(params?: IKNNClassifierParameters) {
    const p = new KNNClassifierF64EuclidianF64Parameters().withDistanceHammingF64(new HammingF64())
    ...
    this.classifier = new GenericKNNClassifier(p, {
      bigI64: KNNClassifierF64BigI64HammingF64,
      bigU64: KNNClassifierF64BigU64HammingF64,
      i64: KNNClassifierF64I64HammingF64,
    })
  }
