...
abstract class KNNRegressorStatics {
  private parameters = new KNNRegressorF64EuclidianF64Parameters().withDistanceHammingF64(new HammingF64())
...
class KNNRegressorHamming
  ...
  implements Estimator<XType, YType, KNNRegressorHamming>, Predictor<XType, YType>
{
