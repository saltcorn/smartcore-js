...
abstract class KNNRegressorStatics {
  private parameters = new KNNRegressorF64EuclidianF64Parameters().withDistanceManhattanF64(new ManhattanF64())
...
class KNNRegressorManhattan
  ...
  implements Estimator<XType, YType, KNNRegressorManhattan>, Predictor<XType, YType>
{
