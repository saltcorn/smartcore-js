...
class KNNClassifierEuclidian {
    constructor(params) {
        const p = new index_js_1.KNNClassifierF64EuclidianF64Parameters();
        if (params?.k)
            p.withK(params.k);
        if (params?.algorithm)
        ...
        this.classifier = new generic_js_1.GenericKNNClassifier(p, {
            bigI64: index_js_1.KNNClassifierF64BigI64EuclidianF64,
            bigU64: index_js_1.KNNClassifierF64BigU64EuclidianF64,
            i64: index_js_1.KNNClassifierF64I64EuclidianF64,
        });
    }
    fit(x, y) {
