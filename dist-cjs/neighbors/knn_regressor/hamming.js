...
class KNNRegressorHamming {
    constructor(params) {
        const p = new index_js_1.KNNRegressorF64EuclidianF64Parameters().withDistanceHammingF64(new index_js_1.HammingF64());
        if (params?.k)
            p.withK(params.k);
        if (params?.algorithm)
        ...
        this.regressor = new generic_js_1.GenericKNNRegressor(p, {
            bigI64: index_js_1.KNNRegressorF64BigI64HammingF64,
            bigU64: index_js_1.KNNRegressorF64BigU64HammingF64,
            i64: index_js_1.KNNRegressorF64I64HammingF64,
            f64: index_js_1.KNNRegressorF64F64HammingF64,
        });
    }
    fit(x, y) {
