...
exports.DBSCANF32EuclidianF32Provider = exports.EstimatorProviders = void 0;
const index_js_1 = require("../../core-bindings/index.js");
const index_js_2 = require("../../linalg/dense-matrix/index.js");
const data_frame_js_1 = require("../../data_frame.js");
function toDenseMatrixF32(x) {
    if (x instanceof data_frame_js_1.DataFrame) {
        throw new Error('Unimplemented!');
    }
    else if (x instanceof index_js_2.DenseMatrix) {
        return x.asRsMatrix('f32');
    }
    else if (Array.isArray(x)) {
        return index_js_2.DenseMatrix.f32(x).asRsMatrix('f32');
    }
    else {
...
function toDenseMatrixF64(x) {
    if (x instanceof data_frame_js_1.DataFrame) {
        ...
        return index_js_2.DenseMatrix.f64(x).asRsMatrix('f64');
    }
    else {
        throw new Error('TODO!');
    }
...
exports.DBSCANF32EuclidianF32Provider = DBSCANF32EuclidianF32Provider;
...
class DBSCANF32ManhattanF32Provider {
    parameters(config) {
        const parameters = new index_js_1.DBSCANF32EuclidianF32Parameters().withDistanceManhattanF32(new index_js_1.ManhattanF32());
        setDBSCANParametersValues(parameters, config);
        return parameters;
    }
    estimator(x, _y, parameters) {
    ...
    deserialize(data) {
        return index_js_1.DBSCANF32I32ManhattanF32.deserialize(data);
    }
}
class DBSCANF32MinkowskiF32Provider {
    parameters(config) {
        ...
        const parameters = new index_js_1.DBSCANF32EuclidianF32Parameters().withDistanceMinkowskiF32(new index_js_1.MinkowskiF32(config.p));
        setDBSCANParametersValues(parameters, config);
        return parameters;
    }
    estimator(x, _y, parameters) {
        const xAsF32 = toDenseMatrixF32(x);
        return index_js_1.DBSCANF32I32MinkowskiF32.fit(xAsF32, parameters);
    }
    toMatrix(x) {
        return toDenseMatrixF32(x);
    }
    deserialize(data) {
        return index_js_1.DBSCANF32I32MinkowskiF32.deserialize(data);
    }
}
...
class DBSCANF64EuclidianF64Provider {
    parameters(config) {
        const parameters = new index_js_1.DBSCANF64EuclidianF64Parameters();
        setDBSCANParametersValues(parameters, config);
        return parameters;
    }
    estimator(x, _y, parameters) {
    ...
    deserialize(data) {
        return index_js_1.DBSCANF64I32EuclidianF64.deserialize(data);
    }
}
...
exports.EstimatorProviders = EstimatorProviders;
