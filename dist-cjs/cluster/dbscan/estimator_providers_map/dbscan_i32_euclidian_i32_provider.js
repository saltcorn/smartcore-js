...
class DBSCANI32EuclidianI32Provider {
    parameters(config) {
        const parameters = new index_js_2.DBSCANI32EuclidianI32Parameters();
        (0, parameters_js_1.setDBSCANParametersValues)(parameters, config);
        return parameters;
    }
    estimator(x, _y, parameters) {
        const xAsI32 = index_js_1.converters.toDenseMatrixI32(x);
        return index_js_2.DBSCANI32I32EuclidianI32.fit(xAsI32, parameters);
    }
    toMatrix(x) {
        return index_js_1.converters.toDenseMatrixI32(x);
    }
    deserialize(data) {
        return index_js_2.DBSCANI32I32EuclidianI32.deserialize(data);
    }
}
