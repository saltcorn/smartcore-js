...
class DBSCANU16EuclidianU16Provider {
    parameters(config) {
        const parameters = new index_js_1.DBSCANU16EuclidianU16Parameters();
        (0, parameters_js_1.setDBSCANParametersValues)(parameters, config);
        return parameters;
    }
    estimator(x, _y, parameters) {
        const xAsU16 = x.asRsMatrix('u16');
        return index_js_1.DBSCANU16I32EuclidianU16.fit(xAsU16, parameters);
    }
    toMatrix(x) {
        return x.asRsMatrix('u16');
    }
    deserialize(data) {
        return index_js_1.DBSCANU16I32EuclidianU16.deserialize(data);
    }
}
