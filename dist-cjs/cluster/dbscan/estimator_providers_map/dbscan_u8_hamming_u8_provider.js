...
class DBSCANU8HammingU8Provider {
    parameters(config) {
        const parameters = new index_js_2.DBSCANU8EuclidianU8Parameters().withDistanceHammingU8(new index_js_2.HammingU8());
        (0, parameters_js_1.setDBSCANParametersValues)(parameters, config);
        return parameters;
    }
    estimator(x, _y, parameters) {
        const xAsU8 = index_js_1.converters.toDenseMatrixU8(x);
        return index_js_2.DBSCANU8I32HammingU8.fit(xAsU8, parameters);
    }
    toMatrix(x) {
        return index_js_1.converters.toDenseMatrixU8(x);
    }
    deserialize(data) {
        return index_js_2.DBSCANU8I32HammingU8.deserialize(data);
    }
}
