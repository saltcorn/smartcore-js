...
class DBSCANI32ManhattanI32Provider {
    parameters(config) {
        const parameters = new index_js_1.DBSCANI32EuclidianI32Parameters().withDistanceManhattanI32(new index_js_1.ManhattanI32());
    ...
    estimator(x, _y, parameters) {
        ...
        return index_js_1.DBSCANI32I32ManhattanI32.fit(xAsI32, parameters);
    }
    toMatrix(x) {
        // TODO: Handle case where x is DataFrame
    ...
    deserialize(data) {
        return index_js_1.DBSCANI32I32ManhattanI32.deserialize(data);
    }
}
