...
class DBSCANF32ManhattanF32Provider {
    parameters(config) {
        const parameters = new index_js_2.DBSCANF32EuclidianF32Parameters().withDistanceManhattanF32(new index_js_2.ManhattanF32());
        (0, parameters_js_1.setDBSCANParametersValues)(parameters, config);
        return parameters;
    }
    estimator(x, _y, parameters) {
        const xAsF32 = index_js_1.converters.toDenseMatrixF32(x);
        return index_js_2.DBSCANF32I32ManhattanF32.fit(xAsF32, parameters);
    }
    toMatrix(x) {
        return index_js_1.converters.toDenseMatrixF32(x);
    }
    deserialize(data) {
        return index_js_2.DBSCANF32I32ManhattanF32.deserialize(data);
    }
}
exports.default = DBSCANF32ManhattanF32Provider;
