...
class DBSCANF32MinkowskiF32Provider {
    parameters(config) {
        ...
        const parameters = new index_js_2.DBSCANF32EuclidianF32Parameters().withDistanceMinkowskiF32(new index_js_2.MinkowskiF32(config.p));
        (0, parameters_js_1.setDBSCANParametersValues)(parameters, config);
        return parameters;
    }
    estimator(x, _y, parameters) {
        const xAsF32 = index_js_1.converters.toDenseMatrixF32(x);
        return index_js_2.DBSCANF32I32MinkowskiF32.fit(xAsF32, parameters);
    }
    toMatrix(x) {
        return index_js_1.converters.toDenseMatrixF32(x);
    }
    deserialize(data) {
        return index_js_2.DBSCANF32I32MinkowskiF32.deserialize(data);
    }
}
