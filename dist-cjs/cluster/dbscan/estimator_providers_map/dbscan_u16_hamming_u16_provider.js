...
class DBSCANU16HammingU16Provider {
    parameters(config) {
        const parameters = new index_js_2.DBSCANU16EuclidianU16Parameters().withDistanceHammingU16(new index_js_2.HammingU16());
        (0, parameters_js_1.setDBSCANParametersValues)(parameters, config);
        return parameters;
    }
    estimator(x, _y, parameters) {
        const xAsU16 = index_js_1.converters.toDenseMatrixU16(x);
        return index_js_2.DBSCANU16I32HammingU16.fit(xAsU16, parameters);
    }
    toMatrix(x) {
        return index_js_1.converters.toDenseMatrixU16(x);
    }
    deserialize(data) {
        return index_js_2.DBSCANU16I32HammingU16.deserialize(data);
    }
}
