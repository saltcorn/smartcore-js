...
class DBSCANU32EuclidianU32Provider {
    parameters(config) {
        const parameters = new index_js_2.DBSCANU32EuclidianU32Parameters();
        (0, parameters_js_1.setDBSCANParametersValues)(parameters, config);
        return parameters;
    }
    estimator(x, _y, parameters) {
        const xAsU32 = index_js_1.converters.toDenseMatrixU32(x);
        return index_js_2.DBSCANU32I32EuclidianU32.fit(xAsU32, parameters);
    }
    toMatrix(x) {
        return index_js_1.converters.toDenseMatrixU32(x);
    }
    deserialize(data) {
        return index_js_2.DBSCANU32I32EuclidianU32.deserialize(data);
    }
}
