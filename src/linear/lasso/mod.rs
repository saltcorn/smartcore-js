...
use predict_output_type::LassoPredictOutputType;
use serialize_data::LassoSerializeData;
...
pub struct Lasso {
  ...
  pub(super) predict_output_type: LassoPredictOutputType,
}
...
impl Lasso {
  ...
  pub fn deserialize(data: Buffer) -> Result<Self> {
    let serialize_data: LassoSerializeData = decode_from_slice(data.as_ref(), standard())
