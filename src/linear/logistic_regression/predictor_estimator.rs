...
predictor_estimator_impl! { LogisticRegressionF64I64 }
predictor_estimator_impl! { LogisticRegressionF32I64 }

predictor_estimator_impl! { LogisticRegressionF64U64 }
predictor_estimator_impl! { LogisticRegressionF32U64 }

predictor_estimator_impl! { LogisticRegressionF64I32 }
predictor_estimator_impl! { LogisticRegressionF32I32 }
