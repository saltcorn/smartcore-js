...
#[napi(string_enum)]
pub enum ElasticNetPredictOutputType {
  F64,
  #[default]
  F32,
  I64,
...
impl TryFrom<&TypedArrayVec> for ElasticNetPredictOutputType {
  ...
  fn try_from(value: &TypedArrayVec) -> Result<Self> {
    match value {
      ...
      TypedArrayVec::U32(_) => Err(Error::new(
        ...
        "ElasticNet supported predict output types are f64, f32, i64, u64, and i32.",
      )),
    }
  }
}
