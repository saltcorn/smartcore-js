...
impl Default for KNNRegressorF32EuclidianF32Parameters {
  fn default() -> Self {
    Self::new()
  }
}
...
#[napi]
impl KNNRegressorF32EuclidianF32Parameters {
  #[napi(constructor)]
  pub fn new() -> Self {
    Self {
...
with_distance_impl! {
    self_parameters_export_type: KNNRegressorF32EuclidianF32Parameters,
    other_parameters_export_type: KNNRegressorF32MahalanobisF32Parameters,
    other_distance_export_type: MahalanobisF32
}

// KNNRegressor32ManhattanF32
define_and_base_impl! {
    feature_type: f32,
...
with_distance_impl! {
    self_parameters_export_type: KNNRegressorF32EuclidianF32Parameters,
    other_parameters_export_type: KNNRegressorF32ManhattanF32Parameters,
    other_distance_export_type: ManhattanF32
}

// KNNRegressor32MinkowskiF32
define_and_base_impl! {
    feature_type: f32,
...
with_distance_impl! {
    self_parameters_export_type: KNNRegressorF32EuclidianF32Parameters,
    other_parameters_export_type: KNNRegressorF32MinkowskiF32Parameters,
