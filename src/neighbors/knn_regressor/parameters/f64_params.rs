...
with_distance_impl! {
    self_parameters_export_type: KNNRegressorF64EuclidianF64Parameters,
    other_parameters_export_type: KNNRegressorF64MahalanobisF64Parameters,
    other_distance_export_type: MahalanobisF64
}

// KNNRegressor64ManhattanF64
define_and_base_impl! {
    feature_type: f64,
...
with_distance_impl! {
    self_parameters_export_type: KNNRegressorF64EuclidianF64Parameters,
    other_parameters_export_type: KNNRegressorF64ManhattanF64Parameters,
    other_distance_export_type: ManhattanF64
}

// KNNRegressor64MinkowskiF64
define_and_base_impl! {
    feature_type: f64,
...
with_distance_impl! {
    self_parameters_export_type: KNNRegressorF64EuclidianF64Parameters,
    other_parameters_export_type: KNNRegressorF64MinkowskiF64Parameters,
