...
impl Default for KNNRegressorU64EuclidianU64Parameters {
  fn default() -> Self {
    Self::new()
  }
}
...
#[napi]
impl KNNRegressorU64EuclidianU64Parameters {
  #[napi(constructor)]
  pub fn new() -> Self {
    Self {
...
with_distance_impl! {
    self_parameters_export_type: KNNRegressorU64EuclidianU64Parameters,
    other_parameters_export_type: KNNRegressorU64ManhattanU64Parameters,
