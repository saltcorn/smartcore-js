...
impl Default for KNNClassifierF32EuclidianF32Parameters {
  fn default() -> Self {
    Self::new()
  }
}
...
#[napi]
impl KNNClassifierF32EuclidianF32Parameters {
  #[napi(constructor)]
  pub fn new() -> Self {
    Self {
...
with_distance_impl! {
    self_parameters_export_type: KNNClassifierF32EuclidianF32Parameters,
    other_parameters_export_type: KNNClassifierF32MahalanobisF32Parameters,
    other_distance_export_type: MahalanobisF32
}

// KNNClassifier32ManhattanF32
define_and_base_impl! {
    feature_type: f32,
...
with_distance_impl! {
    self_parameters_export_type: KNNClassifierF32EuclidianF32Parameters,
    other_parameters_export_type: KNNClassifierF32ManhattanF32Parameters,
    other_distance_export_type: ManhattanF32
}

// KNNClassifier32MinkowskiF32
define_and_base_impl! {
    feature_type: f32,
...
with_distance_impl! {
    self_parameters_export_type: KNNClassifierF32EuclidianF32Parameters,
    other_parameters_export_type: KNNClassifierF32MinkowskiF32Parameters,
