...
impl Default for KNNClassifierU32EuclidianU32Parameters {
  fn default() -> Self {
    Self::new()
  }
}
...
#[napi]
impl KNNClassifierU32EuclidianU32Parameters {
  #[napi(constructor)]
  pub fn new() -> Self {
    Self {
...
with_distance_impl! {
    self_parameters_export_type: KNNClassifierU32EuclidianU32Parameters,
    other_parameters_export_type: KNNClassifierU32ManhattanU32Parameters,
