...
impl Default for KNNClassifierU8EuclidianU8Parameters {
  fn default() -> Self {
    Self::new()
  }
}
...
#[napi]
impl KNNClassifierU8EuclidianU8Parameters {
  #[napi(constructor)]
  pub fn new() -> Self {
    Self {
...
// Euclidian -> HammingU8
with_distance_impl! {
    self_parameters_export_type: KNNClassifierU8EuclidianU8Parameters,
    other_parameters_export_type: KNNClassifierU8HammingU8Parameters,
