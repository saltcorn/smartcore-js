...
impl Default for KNNClassifierI64EuclidianI64Parameters {
  fn default() -> Self {
    Self::new()
  }
}
...
#[napi]
impl KNNClassifierI64EuclidianI64Parameters {
  #[napi(constructor)]
  pub fn new() -> Self {
    Self {
...
with_distance_impl! {
    self_parameters_export_type: KNNClassifierI64EuclidianI64Parameters,
    other_parameters_export_type: KNNClassifierI64ManhattanI64Parameters,
    other_distance_export_type: ManhattanI64
}

// KNNClassifierI64MinkowskiI64
define_and_base_impl! {
    feature_type: i64,
...
with_distance_impl! {
    self_parameters_export_type: KNNClassifierI64EuclidianI64Parameters,
    other_parameters_export_type: KNNClassifierI64MinkowskiI64Parameters,
