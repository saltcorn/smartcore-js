...
impl Default for KNNClassifierU16EuclidianU16Parameters {
  fn default() -> Self {
    Self::new()
  }
}
...
#[napi]
impl KNNClassifierU16EuclidianU16Parameters {
  #[napi(constructor)]
  pub fn new() -> Self {
    Self {
...
with_distance_impl! {
    self_parameters_export_type: KNNClassifierU16EuclidianU16Parameters,
    other_parameters_export_type: KNNClassifierU16HammingU16Parameters,
