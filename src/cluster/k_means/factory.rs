...
use crate::{
  cluster::k_means::predict_output_type::KMeansPredictOutputType,
...
impl KMeansFactory {
  pub fn create<'a>(params: NewParameters<'a>) -> Result<Box<dyn PredictorEstimator>> {
    ...
    match (fit_data_variant_type, params.predict_output_type) {
      (DenseMatrixType::F64, KMeansPredictOutputType::I32) => {
        LibKMeansFactory::f64_i32(params.into())
      }
      (DenseMatrixType::F64, KMeansPredictOutputType::I64) => {
        LibKMeansFactory::f64_i64(params.into())
      }
      (DenseMatrixType::F32, KMeansPredictOutputType::I32) => {
        LibKMeansFactory::f32_i32(params.into())
      }
      (DenseMatrixType::F32, KMeansPredictOutputType::I64) => {
        LibKMeansFactory::f32_i64(params.into())
      }
      (DenseMatrixType::I64, KMeansPredictOutputType::I32) => {
        LibKMeansFactory::i64_i32(params.into())
      }
      (DenseMatrixType::I64, KMeansPredictOutputType::I64) => {
        LibKMeansFactory::i64_i64(params.into())
      }
      (DenseMatrixType::I32, KMeansPredictOutputType::I32) => {
        LibKMeansFactory::i32_i32(params.into())
      }
      (DenseMatrixType::I32, KMeansPredictOutputType::I64) => {
        LibKMeansFactory::i32_i64(params.into())
      }
      (DenseMatrixType::U64, KMeansPredictOutputType::I32) => {
        LibKMeansFactory::u64_i32(params.into())
      }
      (DenseMatrixType::U64, KMeansPredictOutputType::I64) => {
        LibKMeansFactory::u64_i64(params.into())
      }
      (DenseMatrixType::U32, KMeansPredictOutputType::I32) => {
        LibKMeansFactory::u32_i32(params.into())
      }
      (DenseMatrixType::U32, KMeansPredictOutputType::I64) => {
