...
predictor_estimator_impl! { CategoricalNBU64 }
predictor_estimator_impl! { CategoricalNBU32 }
predictor_estimator_impl! { CategoricalNBU16 }
predictor_estimator_impl! { CategoricalNBU8 }
