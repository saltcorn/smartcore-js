...
use predict_output_type::BernoulliNBPredictOutputType;
use serialize_data::BernoulliNBSerializeData;

#[napi(js_name = "BernoulliNB")]
#[derive(Debug)]
...
impl BernoulliNB {
  ...
  pub fn deserialize(data: Buffer) -> Result<Self> {
    let serialize_data: BernoulliNBSerializeData = decode_from_slice(data.as_ref(), standard())
