...
mod deserialize;
mod factory;
mod lib_extra_trees_regressor_factory;
...
use predict_output_type::ExtraTreesRegressorPredictOutputType;
use serialize_data::ExtraTreesRegressorSerializeData;

#[napi(js_name = "ExtraTreesRegressor")]
#[derive(Debug)]
pub struct ExtraTreesRegressor {
  pub(super) inner: Box<dyn PredictorEstimator>,
  pub(super) fit_data_variant_type: DenseMatrixType,
  pub(super) predict_output_type: ExtraTreesRegressorPredictOutputType,
}
...
impl ExtraTreesRegressor {
  ...
  pub fn deserialize(data: Buffer) -> Result<Self> {
    let serialize_data: ExtraTreesRegressorSerializeData =
