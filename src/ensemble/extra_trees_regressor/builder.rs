...
use super::{
  factory::{self, ExtraTreesRegressorFactory, ExtraTreesRegressorParameters},
  ExtraTreesRegressor,
};
use crate::{
...
#[napi(js_name = "ExtraTreesRegressorBuilder")]
pub struct ExtraTreesRegressorBuilder {
...
#[napi]
impl ExtraTreesRegressorBuilder {
  #[napi(constructor)]
  pub fn new(
  ...
  pub fn build(&mut self) -> Result<ExtraTreesRegressor> {
    ...
    let params = factory::NewParameters {
      ...
      extra_trees_regressor_parameters: ExtraTreesRegressorParameters {
